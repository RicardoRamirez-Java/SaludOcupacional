    ...
    public Preguntas() {
     ...
     public Vector getPreguntas() {
        ...
        try {
            ...
            String s = "SELECT * FROM public.preguntasSalud ORDER BY codigo ASC";
        ...
        {   //SE LLAMA A LA CLASE  Y SE LE PASA LOS PARAMETORS OBTENIDOS DELA BASE
           BeanPreguntas rpv=new BeanPreguntas(rS.getInt(1),rS.getString(2),rS.getString(3),rS.getString(4)); 
           v.addElement(rpv);
