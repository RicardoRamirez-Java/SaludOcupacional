...
public class Test_RealizadoBD {
    ...
    public void registrarDetalleTest(int codigoTest, int codigoPregunta, String respuesta) {
      ...
      public void actualizaEstadoEncuesta(String estadoEncuesta, int codigoUsuario) {
        try {
             c = PollDeConexiones.getInstance().getConnection();
            String s = "update Temp_usuarios set estado='" + estadoEncuesta + "' where id_empleado='" + codigoUsuario + "'";
            PreparedStatement p = c.prepareStatement(s);
