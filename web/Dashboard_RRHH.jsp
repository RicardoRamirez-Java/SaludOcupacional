                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">Reporte de Gestores que realizaron el test</p>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <h3>Reporte Posibles Casos de COVID</h3>         
                            </div>
                            <div class="card-body">
                                <p class="card-text">Lista de Gestores que respodieron SI</p>
